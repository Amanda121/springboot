...
//    @Autowired
//    private PmsProduct pd;

    @Override
    public int setCoupon(Long id, String message){

        PmsProduct pd = productMapper.selectByPrimaryKey(id);
        pd.setDiscount(message);
        return productMapper.updateByPrimaryKey(pd);
    }
    ...
    @Override
    public List<PmsProduct> listByKey(Integer pageNum, Integer pageSize, String keyword){
        PageHelper.startPage(pageNum, pageSize);
        PmsProductExample productExample = new PmsProductExample();
        PmsProductExample.Criteria criteria = productExample.createCriteria();
        criteria.andDeleteStatusEqualTo(0);
        productExample.setKey(keyword);

        return productDao.getProductByKey(productExample);
    }
    ...
    @Override
    public List<PmsProduct> list(Integer pageNum, Integer pageSize, String type, String sortBy, String createTime) {
        PageHelper.startPage(pageNum, pageSize);
        PmsProductExample productExample = new PmsProductExample();
        PmsProductExample.Criteria criteria = productExample.createCriteria();
        criteria.andDeleteStatusEqualTo(0);

        productExample.setType(type);
        productExample.setDateOfCreate(createTime);
        productExample.setSortBy(sortBy);
        return productMapper.selectByExample(productExample);
//        if (productQueryParam.getType() != null) {
//
//            productExample.setType(productQueryParam.getType());
//        }
//        if (productQueryParam.getSortBy() != null) {
//            productExample.setOrderByClause(productQueryParam.getSortBy());
//        }
//        if (productQueryParam.getCreateTime() != null) {
//            productExample.setDateOfCreate(productQueryParam.getCreateTime());
//        }
    }
