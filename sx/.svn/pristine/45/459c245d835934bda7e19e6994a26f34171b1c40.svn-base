...
CREATE TABLE `first` (
  ...
  `id` int(255) NOT NULL DEFAULT '99',
  PRIMARY KEY (`id`)
...
-- Records of first
-- ----------------------------
INSERT INTO `first` VALUES ('zs', '12', 'girl', '0');
INSERT INTO `first` VALUES ('cg', '15', 'girl', '2');
INSERT INTO `first` VALUES ('xy', '11', 'boy', '3');
INSERT INTO `first` VALUES ('df', '23', 'boy', '4');
INSERT INTO `first` VALUES ('hz', '12', 'boy', '5');
INSERT INTO `first` VALUES ('string', '20', 'string', '99');
...
INSERT INTO `oms_order_operate_history` VALUES ('23', '12', '后台管理员', '2019-08-19 18:28:41', '5', '修改费用信息');
...
CREATE TABLE `oms_order_return_reason` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='退货原因表';
...
INSERT INTO `oms_order_return_reason` VALUES ('16', '尺码太大啦', '1', '1', '2019-08-19 18:35:14');
INSERT INTO `oms_order_return_reason` VALUES ('17', '尺码太大啦水水水水水水水水', '1', '1', '2019-08-19 18:37:13');
...
CREATE TABLE `pms_product` (
  ...
  `publishTime` date DEFAULT NULL COMMENT '促销开始时间',
  ...
  `discount` varchar(255) DEFAULT NULL COMMENT '优惠码',
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `pms_product` VALUES ('1', '49', '7', '0', '0', '银色星芒刺绣网纱底裤', 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180522/web.png', 'No86577', '1', '1', '1', '1', '1', '100', '0', '100.00', null, '0', '100', null, '111', '111', '120.00', '100', '20', '件', '1000.00', '0', null, '银色星芒刺绣网纱底裤', '银色星芒刺绣网纱底裤', null, '银色星芒刺绣网纱底裤', '银色星芒刺绣网纱底裤', '银色星芒刺绣网纱底裤', '银色星芒刺绣网纱底裤', null, null, null, '0', '七匹狼', '外套', 'SSSSSxsxxxxxx');
...
INSERT INTO `pms_product` VALUES ('22', '6', '7', '0', '1', 'test', 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180604/1522738681.jpg', '', '1', '1', '0', '0', '0', '0', '0', '0.00', null, '0', '0', '0', 'test', '', '0.00', '100', '0', '', '0.00', '1', '1,2', '', '', '', '', '', '', '', null, null, '0', '0', '小米', '外套', null);
...
INSERT INTO `pms_product` VALUES ('28', '6', '19', '0', '3', '小米 红米5A 全网通版 3GB+32GB 香槟金 移动联通电信4G手机 双卡双待', 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180615/5a9d248cN071f4959.jpg', '7437789', '0', '1', '1', '1', '0', '0', '0', '649.00', null, '649', '649', '0', '8天超长待机，137g轻巧机身，高通骁龙处理器小米6X低至1299，点击抢购', '', '649.00', '100', '0', '', '0.00', '0', '', '', '', '', '', '', '', '', null, null, '0', '4', '小米', '手机通讯', null);
INSERT INTO `pms_product` VALUES ('29', '51', '19', '0', '3', 'Apple iPhone 8 Plus 64GB 红色特别版 移动联通电信4G手机', 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180615/5acc5248N6a5f81cd.jpg', '7437799', '0', '1', '1', '0', '0', '0', '0', '5499.00', null, '5499', '5499', '0', '【限时限量抢购】Apple产品年中狂欢节，好物尽享，美在智慧！速来 >> 勾选[保障服务][原厂保2年]，获得AppleCare+全方位服务计划，原厂延保售后无忧。', '', '5499.00', '100', '0', '', '0.00', '0', '', '', '', '', '', '', '', '', null, null, '0', '0', '苹果', '手机通讯', null);
...
INSERT INTO `ums_admin_login_log` VALUES ('18', '3', '2019-08-07 23:55:19', '127.0.0.1', null, null);
INSERT INTO `ums_admin_login_log` VALUES ('19', '3', '2019-08-08 00:00:29', '127.0.0.1', null, null);
INSERT INTO `ums_admin_login_log` VALUES ('20', '3', '2019-08-08 00:06:23', '127.0.0.1', null, null);
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `aa` AS select `c1`.`name` AS `name` from `pms_product_category` `c1` where (`c1`.`parent_id` = 0) ;
